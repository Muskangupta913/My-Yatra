...
>>>>>>> c45ccef0719f337b2cb184f031991164ea36b713
...
>>>>>>> c45ccef0719f337b2cb184f031991164ea36b713
        ...
        function renderDestinationList() {
            ...
            selectedDestinations.forEach((destination, index) => {
                const destinationTotal = destination.price * (destination.adults + destination.children);
                ...
                div.innerHTML = `
                    <div>
                        ...
                        <p class="mt-2 font-bold">Total: ₹${destinationTotal}</p>
                    </div>
                    <i class="fas fa-times" onclick="removeDestination(${index})"></i>
                `;
        ...
        function updateQuantity(index, type, change) {
            if (selectedDestinations[index][type] + change >= 0) {
