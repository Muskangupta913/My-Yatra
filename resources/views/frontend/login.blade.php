...
>>>>>>> 561d0dc11a15b269f6d9c9f3ab5a840a22a4b16d
        }
...
document.getElementById('submitButton').addEventListener('click', function(event) {
    ...
    if (isLCC) {
        ...
        // Add selected SSR options if they exist
        if (window.selectedBaggageOption) {
            payload.passenger.baggage = [window.selectedBaggageOption];
        }
        if (window.selectedMealOption) {
            payload.passenger.mealDynamic = [window.selectedMealOption];
        }
        
        // Get selected seat if exists
