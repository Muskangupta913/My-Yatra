...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Tour Place</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('tourPlace.update', $tourPlace->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <select name="state_id" class="form-control" id="state" required>
                                ...
                                @foreach ($states as $state)
                                    <option value="{{ $state->id }}" {{ $tourPlace->state_id == $state->id ? 'selected' : '' }}>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="city_id" class="form-control" id="city" required>
                                ...
                                @foreach ($cities as $city)
                                    <option value="{{ $city->id }}" {{ $tourPlace->city_id == $city->id ? 'selected' : '' }}>
                                        {{ $city->city_name }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="{{ $tourPlace->name }}" required>
                            @error('name')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="price" name="price" value="{{ $tourPlace->price }}" required>
                            @error('price')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="description" class="form-control summernote" id="description" cols="30" rows="5" required>{{ $tourPlace->description }}</textarea>
                    @error('description')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            @error('photo')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                            <img src="{{ asset('storage/' . $tourPlace->photo) }}" width="100" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="video" name="video" value="{{ $tourPlace->video }}" placeholder="YouTube or Vimeo URL">
                            @error('video')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                ...
                <div class="form-group text-center mt-4">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save mr-1"></i> Update Tour Place
                    </button>
