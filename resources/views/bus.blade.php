                    ...
                    <div class="row">
                      ...
                      <div class="col-md-7">
                              <!--  main Image -->
                                ...
                                <img src="./images/bus.img" style="height: 400px !important;" class="object-fit-cover img-fluid rounded" 
                                ...
                                <h3 class="hotelname fs-4" style="margin-top: -20px;">Bus</h3>
                                <p>Mapusa Road, Goa</p>
                            </div>
...
<div id="slider" class="carousel slide" data-bs-interval="false"> <!-- Removed auto-swiping -->
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            ...
            <div class="card">
            <p class="card-text fw-bold mt-3">AC Bus</p>
            ...
            <span class="text-danger fs-8 fw-bold ms-2">
              10 % off<span id="discountedPrice"></span>
                ...
                <div class="card">
                <p class="card-text fw-bold mt-3">Non Ac Bus</p>
                <button class="btn btn-success btn-lg d-flex align-items-center justify-content-center mx-auto">
                    <span class="me-2">Per Person Price</span>
                ...
                <div class="card">
                <p class="card-text fw-bold mt-3">Sleeper </p>
                <button class="btn btn-success btn-lg d-flex align-items-center justify-content-center mx-auto">
                    <span class="me-2">Per Person Price</span>
...
<!--First card  Modal end-->

<!-- 
                <div class="hotel-item" data-price="10000-20000" data-company="oberoi" data-review="4-star">
                    <h5>Oberoi Palace</h5>
                    <p>Price: ₹12,000 | Company: Oberoi Group | Review: 4 Star</p>
                </div>
                <div class="hotel-item" data-price="20000-35000" data-company="itc" data-review="3-star">
                    <h5>ITC Grand</h5>
                    <p>Price: ₹25,000 | Company: ITC Hotels | Review: 3 Star</p>
                </div>
            </div>
        </div>
    </div>
