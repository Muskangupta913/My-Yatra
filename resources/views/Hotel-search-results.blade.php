        ...
        function applyFilters() {
            ...
            filteredHotels = allHotels.filter(hotel => {
                ...
                return (
                    ...
                    (activeFilters.starRating.length === 0 || activeFilters.starRating.includes(stars)) &&
                    (activeFilters.propertyType.length === 0 || activeFilters.propertyType.includes(type)) &&
                    (activeFilters.amenities.length === 0 || activeFilters.amenities.every(a => hotelAmenities.includes(a)))
                );
            });
