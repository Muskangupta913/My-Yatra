...
<head>
    ...
    <title> Travel & Tour Booking Agency</title>
...
<header class="th-header header-layout3 header-absolute" style="background-color:black">
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto">
                        <nav class="main-menu d-none d-xl-block">
                            <ul>
                                <li><a class="active" href="home-travel.html">Home</a>  </li>
                                <li><a href="about.html">About Us</a></li>
                    ...
                    <div class="col-auto">
                        <div class="header-logo"><a href="index.html"><img src="https://makemybharatyatra.com/wp-content/uploads/2024/05/new_logo-removebg-preview.png"  width="120"
                                    alt="Tourm"></a></div>
                    </div>
                    <div class="col-auto">
                        <nav class="main-menu d-none d-xl-block">
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="widget footer-widget">
                                <div class="th-widget-about">
                                    <div class="about-logo"><a href="home-travel.html"><img src="assets/img/logo-white.svg"
                                                alt="Tourm"></a></div>
