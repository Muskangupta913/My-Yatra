...
<div class="container py-5">
  ...
  <div class="swiper packageDetailsSlider">
    ...
    <div class="swiper-pagination"></div>
        ...
        <div class="col-md-4 mb-3 holiday-price-box">
                ...
                <div class="card-body">
                  ...
                  @endphp
                    ...
                    <div class="price-offer d-flex justify-content-between align-items-center">
                      ...
                      <button class="btn btn-danger btn-lg rounded-0" id="booknow" data-bs-toggle="modal" data-bs-target="#bookingModal">Bookk Now</button>
                     </div>
                </div>
            </div>
        </div>
